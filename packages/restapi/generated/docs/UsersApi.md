...
|------------- | ------------- | -------------|
|[**userControllerCreate**](#usercontrollercreate) | **POST** /users | Create new user|
|[**userControllerFindAll**](#usercontrollerfindall) | **GET** /users | |
|[**userControllerFindById**](#usercontrollerfindbyid) | **GET** /users/{id} | Get user by Id|

# **userControllerCreate**
> UserResponseDto userControllerCreate()
